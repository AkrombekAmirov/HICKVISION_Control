...
class User(SQLModel, table=True):
    ...
    jshshir: Optional[str] = Field(default=None, max_length=20)
...
class TTJ5(SQLModel, table=True):
    id: Optional[int] = Field(default=None, primary_key=True)
...
class TTJ7(SQLModel, table=True):
    id: Optional[int] = Field(default=None, primary_key=True)
...
class TTJ8(SQLModel, table=True):
    id: Optional[int] = Field(default=None, primary_key=True)
...
class TTJ9(SQLModel, table=True):
    id: Optional[int] = Field(default=None, primary_key=True)
...
class TTJ10(SQLModel, table=True):
    id: Optional[int] = Field(default=None, primary_key=True)
