...
from DataConfig.config import DATABASE_URL
...
class DatabaseService1:
    ...
    async def get_limit(self, model: Type[SQLModel], filters: Optional[Dict[str, Any]] = None, limit: Optional[int] = None) -> \
    List[SQLModel]:
        """
        Jadvaldan yozuvlarni olish.
        :param model: SQLModel jadvali turi.
        :param filters: Filtlash shartlari (masalan, {"id__gte": 1, "turniket_id__gte": 1170}).
        :param limit: Qaytariladigan yozuvlar soni.
        :return: Model yozuvlari.
        """
        async with self.session_scope() as session:
